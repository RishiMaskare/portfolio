...
import { FaPython, FaHtml5, FaCss3, FaJs, FaReact, FaNodeJs, FaGitAlt, FaGithub } from "react-icons/fa";
...
export default function Skills() {
  ...
  return (
    <section id="skills"
    ref={sectionRef} className="h-1/2 w-full pb-8 flex flex-col items-center justify-center bg-black text-white overflow-hidden">
